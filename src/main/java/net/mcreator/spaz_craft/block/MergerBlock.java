...
package net.mcreator.spaz_craft.block;
...
import net.mcreator.spaz_craft.procedures.MergerUpdateTickProcedure;
import net.mcreator.spaz_craft.gui.MergerGuiGui;
...
public class MergerBlock extends SpazCraftElements.ModElement {
	@ObjectHolder("spaz_craft:merger")
	public static final Block block = null;
	@ObjectHolder("spaz_craft:merger")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public MergerBlock(SpazCraftElements instance) {
		super(instance, 1);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, World world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				MergerUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
