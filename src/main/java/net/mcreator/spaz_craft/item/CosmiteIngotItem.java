...
public class CosmiteIngotItem extends SpazCraftElements.ModElement {
	@ObjectHolder("spaz_craft:cosmiteingot")
	public static final Item block = null;
	public CosmiteIngotItem(SpazCraftElements instance) {
		super(instance, 14);
	}
