...
package net.mcreator.spaz_craft.gui;
...
public class MergerGuiGui extends SpazCraftElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public MergerGuiGui(SpazCraftElements instance) {
		super(instance, 3);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("mergergui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new Slot(internal, 0, 26, 30) {
			}));
			this.customSlots.put(1, this.addSlot(new Slot(internal, 1, 134, 48) {
			}));
			this.customSlots.put(2, this.addSlot(new Slot(internal, 2, 80, 39) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				SpazCraft.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("spaz_craft:textures/mergergui.png");
		@Override
